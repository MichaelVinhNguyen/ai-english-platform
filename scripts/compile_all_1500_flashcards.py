"""
compile_all_1500_flashcards.py
Builds and seeds the complete 30 Topics x 50 Words = 1,500 Flashcards dataset.
"""
...
# We build dictionaries for all 30 topics.
# Every topic has exactly 50 words, each with:
# (word, ipa, word_type, level, definition_vi, definition_en, examples, synonyms, collocations)
