"""
build_and_seed_30_topics.py
Compiles 30 distinct topics with 50 words each (1,500 words total)
...
# Data for 30 Topics x 50 Words = 1,500 Flashcards
RAW_TOPICS = [
    {
        "name": "Daily Life & Routines",
        "icon": "☕",
        "color": "#f59e0b",
        "desc": "Thói quen hàng ngày, sinh hoạt và nhịp sống đô thị",
        "words": [
