"""
seed_30_flashcard_topics.py
Comprehensive seeder for 30 distinct flashcard topics x 50 words = 1,500 rich flashcard words.
"""
...
# Master registry of 30 Topics with exact 50 curated words each
FLASHCARD_TOPICS = {
    "Daily Life & Routines": [
