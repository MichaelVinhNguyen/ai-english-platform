"""
scripts/generate_5000_flashcards_engine.py
Generates exactly 50 Topics x 100 Words = 5,000 Flashcards.
"""
...
print("[ENGINE] Starting generation of 5,000 flashcards across 50 topics...")
